...
public class Cookbook
{
    ...
    public void find_toplevel (string original_dir, bool pretty_print) throws CookbookError
    {
        /* Find the toplevel */
    ...
    public void configure (string[] args) throws ConfigureError
    {
    ...
    public Recipe? load_recipes (string filename, bool pretty_print = false, bool is_toplevel = true) throws CookbookError, RecipeError
    {
    ...
    public void setup (bool pretty_print) throws CookbookError, RecipeError
    {
        /* Load configuration */
        try
        {
        ...
        var filename = Path.build_filename (toplevel_dir, "Recipe");
        toplevel = load_recipes (filename, pretty_print);
    ...
    public bool complete () throws Error
    {
        foreach (var option in options)
            if (option.value == null && option.default != null)

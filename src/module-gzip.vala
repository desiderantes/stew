...
class GZIPModule : BuildModule {
	public override void generate_toplevel_rules (Recipe recipe) {
		...
		rule.add_command ("@tar --create --gzip --file %s --directory %s %s".printf (filename, Path.get_dirname (recipe.release_directory), recipe.release_name));
